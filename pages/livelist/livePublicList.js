...
Page({
  ...
  data: {
    ...
    live_list_icon: [{
      icon: '../../image/live/mkcj.png',
      title: '模块串讲'
    }, {
      icon: '../../image/live/dtjq.png',
      title: '答题技巧'
    }, {
      icon: '../../image/live/mkcj.png',
      title: '高频考点串讲'
    }, {
      icon: '../../image/live/jdtj.png',
      title: '公开课'
    }, {
      icon: '../../image/live/qhtf.png',
      title: '画书速记'
    }, {
      icon: '../../image/live/jcyd.png',
      title: '教材研读'
    }, {
      icon: '../../image/live/jdtj.png',
      title: '经典题解'
    }, {
      icon: '../../image/live/kqmx.png',
      title: '考前绝密预测'
    }, {
      icon: '../../image/live/kqmx.png',
      title: '考前密训'
    }, {
      icon: '../../image/live/kqyt.png',
      title: '考前押题'
    }, {
      icon: '../../image/live/qhtf.png',
      title: '强化提分'
    }, {
      icon: '../../image/live/ztsl.png',
      title: '扫雷强化'
    }, {
      icon: '../../image/live/sjcjjj.png',
      title: '试卷超级金讲'
    }, {
      icon: '../../image/live/ycjd.png',
      title: '预习进阶'
    }, {
      icon: '../../image/live/zthg.png',
      title: '真题回顾'
    }, {
      icon: '../../image/live/zthg.png',
      title: '真题精讲'
    }, {
      icon: '../../image/live/zjdp.png',
      title: '终极点评'
    }, {
      icon: '../../image/live/zjmk.png',
      title: '终极模考'
    }, {
      icon: '../../image/live/zdcj.png',
      title: '重点串讲'
    }, {
      icon: '../../image/live/ztsl.png',
      title: '专题扫雷'
  ...
  checkcourse_live_module: function () {
    ...
    api.checkcourse({
      ...
      success: res => {
        ...
        if (data.errcode == 0) {
          //请求成功读取试题-v2.3
          for (var i = 0; i < data.live_module.length; i++) {
            for (var j = 0; j < live_list_icon.length; j++) {
              if (data.live_module[i].shorttitle.replace(/(^\s*)|(\s*$)/g, "") == live_list_icon[j].title) {
                data.live_module[i].icon = live_list_icon[j].icon;
              }
            }
            if (data.live_module[i].icon == undefined) {
              data.live_module[i].icon = live_list_icon[i].icon;
            }
          }
          this.setData({
